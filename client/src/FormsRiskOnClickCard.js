...
export default function FormsRiskOnClickCard({ card }) {
  return (
      ...
      <a href={card.link} className=''>
        <div className="m-4 flex flex-wrap justify-center text-center items-center">
          ...
          <div className="flex flex-col">
            <h1 className="mt-4 font-bold text-blue-700 block text-[9px] sm:text-sm xl:text-lg text-center">{card.title}</h1>
